...
typedef ur_result_t(UR_APICALL *ur_pfnSamplerCreate_t)(
    ur_context_handle_t, const ur_sampler_property_value_t *,
    ur_sampler_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnMemFree_t)(ur_context_handle_t, void *);

///////////////////////////////////////////////////////////////////////////////
/// @brief Function-pointer for urMemGetMemAllocInfo
typedef ur_result_t(UR_APICALL *ur_pfnMemGetMemAllocInfo_t)(ur_context_handle_t,
                                                            const void *,
                                                            ur_mem_alloc_info_t,
                                                            size_t, void *,
                                                            size_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnInit_t)(ur_platform_init_flags_t,
...
typedef ur_result_t(UR_APICALL *ur_pfnQueueCreate_t)(
    ur_context_handle_t, ur_device_handle_t, ur_queue_property_value_t *,
    ur_queue_handle_t *);
...
typedef ur_result_t(UR_APICALL *ur_pfnDevicePartition_t)(
    ur_device_handle_t, ur_device_partition_property_value_t *, uint32_t,
