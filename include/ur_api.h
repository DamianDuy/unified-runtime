...
typedef enum ur_result_t {
    ...
    UR_RESULT_ERROR_INVALID_KERNEL_NAME =
        28, ///< [Validation] kernel name is not found in the module
    UR_RESULT_ERROR_INVALID_KERNEL_ARGUMENT_INDEX =
        29, ///< [Validation] kernel argument index is not valid for kernel
    UR_RESULT_ERROR_INVALID_KERNEL_ARGUMENT_SIZE =
        30, ///< [Validation] kernel argument size does not match kernel
    UR_RESULT_ERROR_INVALID_KERNEL_ATTRIBUTE_VALUE =
        31, ///< [Validation] value of kernel attribute is not valid for the
            ///< kernel or device
    UR_RESULT_ERROR_INVALID_IMAGE_SIZE = 32, ///< Invalid image size
    UR_RESULT_ERROR_INVALID_IMAGE_FORMAT_DESCRIPTOR =
        33, ///< Invalid image format descriptor
    UR_RESULT_ERROR_IMAGE_FORMAT_NOT_SUPPORTED =
        34, ///< Image format not supported
    ...
    UR_RESULT_ERROR_INVALID_PROGRAM_EXECUTABLE =
        36, ///< Program object parameter is invalid.
    UR_RESULT_ERROR_UNINITIALIZED =
        37, ///< [Validation] driver is not initialized
    UR_RESULT_ERROR_OUT_OF_HOST_MEMORY =
        38, ///< Insufficient host memory to satisfy call
    UR_RESULT_ERROR_OUT_OF_DEVICE_MEMORY =
        39, ///< Insufficient device memory to satisfy call
    UR_RESULT_ERROR_OUT_OF_RESOURCES = 40, ///< Out of resources
    UR_RESULT_ERROR_MODULE_BUILD_FAILURE =
        41, ///< Error occurred when building module, see build log for details
    UR_RESULT_ERROR_MODULE_LINK_FAILURE =
        42, ///< Error occurred when linking modules, see build log for details
    UR_RESULT_ERROR_UNSUPPORTED_VERSION =
        43, ///< [Validation] generic error code for unsupported versions
    UR_RESULT_ERROR_UNSUPPORTED_FEATURE =
        44, ///< [Validation] generic error code for unsupported features
    UR_RESULT_ERROR_INVALID_ARGUMENT =
        45, ///< [Validation] generic error code for invalid arguments
    UR_RESULT_ERROR_INVALID_NULL_HANDLE =
        46, ///< [Validation] handle argument is not valid
    UR_RESULT_ERROR_HANDLE_OBJECT_IN_USE =
        47, ///< [Validation] object pointed to by handle still in-use by device
    UR_RESULT_ERROR_INVALID_NULL_POINTER =
        48, ///< [Validation] pointer argument may not be nullptr
    UR_RESULT_ERROR_INVALID_SIZE =
        49, ///< [Validation] size argument is invalid (e.g., must not be zero)
    UR_RESULT_ERROR_UNSUPPORTED_SIZE =
        50, ///< [Validation] size argument is not supported by the device
            ///< (e.g., too large)
    UR_RESULT_ERROR_UNSUPPORTED_ALIGNMENT =
        51, ///< [Validation] alignment argument is not supported by the device
            ///< (e.g., too small)
    UR_RESULT_ERROR_INVALID_SYNCHRONIZATION_OBJECT =
        52, ///< [Validation] synchronization object in invalid state
    UR_RESULT_ERROR_INVALID_ENUMERATION =
        53, ///< [Validation] enumerator argument is not valid
    UR_RESULT_ERROR_UNSUPPORTED_ENUMERATION =
        54, ///< [Validation] enumerator argument is not supported by the device
    UR_RESULT_ERROR_UNSUPPORTED_IMAGE_FORMAT =
        55, ///< [Validation] image format is not supported by the device
    UR_RESULT_ERROR_INVALID_NATIVE_BINARY =
        56, ///< [Validation] native binary is not supported by the device
    UR_RESULT_ERROR_INVALID_GLOBAL_NAME =
        57, ///< [Validation] global variable is not found in the module
    UR_RESULT_ERROR_INVALID_FUNCTION_NAME =
        58, ///< [Validation] function name is not found in the module
    UR_RESULT_ERROR_INVALID_GROUP_SIZE_DIMENSION =
        59, ///< [Validation] group size dimension is not valid for the kernel
            ///< or device
    UR_RESULT_ERROR_INVALID_GLOBAL_WIDTH_DIMENSION =
        60, ///< [Validation] global width dimension is not valid for the kernel
            ///< or device
    UR_RESULT_ERROR_MODULE_UNLINKED =
        61, ///< [Validation] module with imports needs to be linked before
            ///< kernels can be created from it.
    UR_RESULT_ERROR_OVERLAPPING_REGIONS =
        62, ///< [Validation] copy operations do not support overlapping regions
            ///< of memory
    ...
    UR_RESULT_ERROR_OBJECT_ALLOCATION_FAILURE =
        65, ///< Objection allocation failure
    UR_RESULT_ERROR_ADAPTER_SPECIFIC =
        66, ///< An adapter specific warning/error has been reported and can be
...
///     - ::UR_RESULT_ERROR_OUT_OF_HOST_MEMORY
///     - ::UR_RESULT_ERROR_OUT_OF_RESOURCES
UR_APIEXPORT ur_result_t UR_APICALL urEnqueueUSMMemAdvice(
    ur_queue_handle_t hQueue, ///< [in] handle of the queue object
    const void *pMem,         ///< [in] pointer to the USM memory object
...
typedef enum ur_mem_alloc_info_t {
    ...
    UR_MEM_ALLOC_INFO_ALLOC_BASE_PTR =
        1,                              ///< Memory allocation base pointer info
...
///     - ::UR_RESULT_ERROR_INVALID_MEM_OBJECT
///     - ::UR_RESULT_ERROR_OUT_OF_HOST_MEMORY
UR_APIEXPORT ur_result_t UR_APICALL urMemFree(
    ur_context_handle_t hContext, ///< [in] handle of the context object
...
///     - ::UR_RESULT_ERROR_INVALID_MEM_OBJECT
///     - ::UR_RESULT_ERROR_OUT_OF_HOST_MEMORY
UR_APIEXPORT ur_result_t UR_APICALL urMemGetMemAllocInfo(
    ur_context_handle_t hContext, ///< [in] handle of the context object
    ...
    size_t
        *pPropValueSizeRet ///< [out] bytes returned in USM allocation property
);
...
typedef enum ur_device_info_t {
    ...
    UR_DEVICE_INFO_PARTITION_PROPERTIES =
        76, ///< uint32_t: return a bit-field of partition properties
    ...
    UR_DEVICE_INFO_PARTITION_TYPE =
        79, ///< uint32_t: return a bit-field of
            ///< ::ur_device_partition_property_flags_t for properties specified
            ///< in ::urDevicePartition
    ...
    UR_DEVICE_INFO_MAX_COMPUTE_QUEUE_INDICES =
        99, ///< uint32_t: Returns 1 if the device doesn't have a notion of a
...
typedef enum ur_device_partition_property_flag_t {
    UR_DEVICE_PARTITION_PROPERTY_FLAG_EQUALLY =
        UR_BIT(0), ///< Support equal partition
    UR_DEVICE_PARTITION_PROPERTY_FLAG_BY_COUNTS =
        UR_BIT(1), ///< Support partition by count
    UR_DEVICE_PARTITION_PROPERTY_FLAG_BY_AFFINITY_DOMAIN =
        UR_BIT(2), ///< Support partition by affinity domain
...
typedef enum ur_platform_init_flag_t {
    UR_PLATFORM_INIT_FLAG_LEVEL_ZERO =
        UR_BIT(0), ///< initialize Unified Runtime platform drivers
...
/// @param[in] pTracerUserData Per-Tracer user data
/// @param[in,out] ppTracerInstanceUserData Per-Tracer, Per-Instance user data
typedef void(UR_APICALL *ur_pfnMemFreeCb_t)(ur_mem_free_params_t *params,
                                            ur_result_t result,
                                            void *pTracerUserData,
                                            void **ppTracerInstanceUserData);
...
typedef void(UR_APICALL *ur_pfnMemGetMemAllocInfoCb_t)(
    ur_mem_get_mem_alloc_info_params_t *params, ur_result_t result,
    void *pTracerUserData, void **ppTracerInstanceUserData);
...
typedef void(UR_APICALL *ur_pfnEnqueueUSMMemAdviceCb_t)(
    ur_enqueue_usm_mem_advice_params_t *params, ur_result_t result,
    void *pTracerUserData, void **ppTracerInstanceUserData);
