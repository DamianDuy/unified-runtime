...
///     - ::UR_RESULT_ERROR_OUT_OF_HOST_MEMORY
///     - ::UR_RESULT_ERROR_OUT_OF_RESOURCES
ur_result_t UR_APICALL urEnqueueUSMMemAdvice(
    ur_queue_handle_t hQueue, ///< [in] handle of the queue object
    const void *pMem,         ///< [in] pointer to the USM memory object
...
///     - ::UR_RESULT_ERROR_INVALID_MEM_OBJECT
///     - ::UR_RESULT_ERROR_OUT_OF_HOST_MEMORY
ur_result_t UR_APICALL urMemFree(
    ur_context_handle_t hContext, ///< [in] handle of the context object
...
///     - ::UR_RESULT_ERROR_INVALID_MEM_OBJECT
///     - ::UR_RESULT_ERROR_OUT_OF_HOST_MEMORY
ur_result_t UR_APICALL urMemGetMemAllocInfo(
    ur_context_handle_t hContext, ///< [in] handle of the context object
    ...
    auto pfnGetMemAllocInfo =
        ur_lib::context->urDdiTable.Mem.pfnGetMemAllocInfo;
...
ur_result_t UR_APICALL urDevicePartition(
    ...
    return pfnPartition(hDevice, Properties, NumDevices, phSubDevices,
                        pNumDevicesRet);
}
